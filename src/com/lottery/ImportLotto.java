...
public class ImportLotto extends ImportBase{


    DataSourceOper sconn = new DataSourceOper();

    final static String URL_PATH = "http://www.17500.cn//getData//dlt.TXT";
    ...
    public void InsertValue(String val) {
        ...
        String sql = null;
        try {
            sql = "insert into SUPER_LOTTO values(" + readyvalue(val) + ");";
